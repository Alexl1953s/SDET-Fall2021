...
public class MultipleIfStatements {
    ...
    public static void main(String[] args) {
        ...
        if(numberOfDay == 1) System.out.println("Monday, Weekday");
        if(numberOfDay == 2) System.out.println("Tuesday, Weekday");
        if(numberOfDay == 3) System.out.println("Wednesday, Weekday");
        if(numberOfDay == 4) System.out.println("Thursday, Weekday");
