...
public class ConstantVariables {
    ...
    public static void main(String[] args) {
        ...
        // whatever the value that's one the right side of the '=' sign
        // will get assigned to the variable on the left of the '='
        // EX: int a;
        // a = 5; we are assigning 5 to variable a and this is also know as initialization of a variable
        ...
        // There are variables called constants and they are also known as final variables because "final"
        // keyword is used in initialization of the variable
